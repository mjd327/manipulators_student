...

{
	...
	protected void setProjectionAndLighting(GL2 gl, SceneProgram program, CameraController cameraController)
	{
		...
		scene.setupLighting(gl, program, cameraController.getModelView());
	...
	public void draw(GLAutoDrawable drawable, CameraController cameraController)
	{
		...
		setProjectionAndLighting(gl, programToUse, cameraController);

		if (sceneViewPanel.isWireframeMode())
		{
			scene.renderWireframe(gl, programToUse, cameraController.getModelView());
		}
		else
		{
			scene.render(gl, programToUse, cameraController.getModelView());
		}
	...
	public void drawPicking(GLAutoDrawable drawable, CameraController controller) {
		...
		scene.renderPicking(gl, pickingProgram, controller.getModelView());
